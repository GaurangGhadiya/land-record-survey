  ...
  export default function Aadhar({ selectedFamily }) {
    ...
    if (selectedFamily?.name) {
      extractedFamilyData = {
        ...
        po: selectedFamily?.po,
        state: selectedFamily?.state,
        subdist: selectedFamily?.subdist,
        pincode: selectedFamily?.pc,
        gender: selectedFamily?.gender == "M" ? "Male" : "Female",
      }
              ...
              <Box flexBasis="80%">
                ...
                >
                  <Box
                    ...
                    gap={1}
                  >
                    {selectedFamily?.name  ?<><Box style={{ textAlign: "center" }}>
        ...
        .slice(-4)}`}
            ...
            <AccordionDetails>
              ...
              >
                ...
                {selectedFamily?.photoUrl && <> <Box
                  ...
                  <Box  style={{
                    ...
                    ><img src={selectedFamily?.photoUrl} height={200} width={150}
                    onClick={() => handleToggleEnlarged1(selectedFamily?.photoUrl)}
             ...
             <Box
                  ...
                  >
                  {selectedFamily?.docUrl &&  <><Box  style={{
                        flex: 1,
                        textAlign: "right",
                        paddingRight: "5px",
                        fontWeight: "bold",
                    ...
                    ><img src={selectedFamily?.docUrl} height={200} width={150}
                    onClick={() => handleToggleEnlarged1(selectedFamily?.docUrl)}
