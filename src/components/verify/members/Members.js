...
export default function Members({ memberObject }) {
  ...
  const memberObject1 = {
    ...
    meterNumber: memberObject?.meterNumber,
    consumerId : memberObject?.consumerId,
    load : memberObject?.load,
    address : memberObject?.address,
    isConsumerAlive : memberObject?.isConsumerAlive == true ? "Yes" : "No",
