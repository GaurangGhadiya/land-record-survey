import {
  ...
  export default function Corp({ selectedFamily }) {
    const extractedFamilyData = {
      nameHotel: selectedFamily.nameHotel,
      nameHotelOwner: selectedFamily.nameHotelOwner,
      divisionName: selectedFamily.divisionName,
      subDivisionName: selectedFamily.subDivisionName,
      address: selectedFamily.address,
      locationType: selectedFamily.locationType,
      districtName: selectedFamily.districtName,
      municipalityName: selectedFamily.municipalityName,
                  ...
                  >
                    <Box style={{ textAlign: "center" }}>
                      <Typography variant="subtitle1">
                        {selectedFamily?.nameHotel}
                      </Typography>
                    </Box>
                    <Box style={{ textAlign: "center" }}>
                      <Typography variant="subtitle1">
                        {selectedFamily?.nameHotelOwner}
                      </Typography>
                    </Box>
                    <Box style={{ textAlign: "center" }}>
                      <Typography variant="subtitle1">
                        {selectedFamily?.locationType}
                      </Typography>
                    </Box>
                    <Box style={{ textAlign: "center" }}>
                      <Typography variant="subtitle1">
